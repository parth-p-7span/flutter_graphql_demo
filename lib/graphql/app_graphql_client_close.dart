...
class AppGraphqlClientClose {
  GraphQLClient? _client;

  AppGraphqlClientClose(
    String graphQlUrl,
  ) {
    final httpLink = HttpLink(graphQlUrl);
    final _authLink = AuthLink(getToken: () => testingToken);

    Link _link = _authLink.concat(httpLink);

    print("------" + _authLink.toString());
